...
import com.noar.orm.Constants;
import com.noar.orm.exception.NoarOrmRuntimeException;
import com.noar.orm.model.Page;
import com.noar.orm.model.SearchCondition;
import com.noar.orm.model.SortCondition;
import com.noar.orm.processor.VelocityProcessor;
...
public class JpaDaoHandler implements Dao {
	...
	public <T> void delete(Class<T> entity, Object key) {
		...
		if (data == null) {
			throw new NoarOrmRuntimeException("Record Not Found (key:" + key + ")", null);
		}
