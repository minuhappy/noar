...
public class FileUtil {
	...
	public static String read(String dirPath, String fileName) {
		return read(dirPath, fileName, CHAR_SET_UTF8);
	}

	public static String read(String dirPath, String fileName, String charSet) {
		return read(new File(dirPath, fileName), charSet);
	}

	public static String read(File file) {
		return read(file, CHAR_SET_UTF8);
	}
	...
	public static String read(File file, String charSet) {
		if (!file.exists())
			return null;
		try {
			return new String(Files.readAllBytes(Paths.get(file.toString())), charSet);
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static void copyInputStreamToFile(final InputStream source, final File destination) throws Exception {
