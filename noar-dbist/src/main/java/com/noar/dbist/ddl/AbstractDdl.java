...
import com.noar.dbist.annotation.Sequence;
import com.noar.dbist.annotation.Table;
import com.noar.dbist.ddl.mapper.DdlMapper;
import com.noar.dbist.ddl.mapper.DdlMapperDB2;
import com.noar.dbist.ddl.mapper.DdlMapperH2;
import com.noar.dbist.ddl.mapper.DdlMapperMysql;
...
public abstract class AbstractDdl implements Ddl {
	...
	@Override
	public com.noar.dbist.metadata.Table getTable(String tableName) {
		return this.dml.getTable(tableName);
	}

	@Override
	public com.noar.dbist.metadata.Table getTable(Class<?> entityClass) {
	...
	public List<TableIdx> getTableIndexes(Class<?> entityClass) {
		...
		com.noar.dbist.annotation.Index[] indexes = (com.noar.dbist.annotation.Index[]) tableInfo.get("indexes");
		String tableName = (String) tableInfo.get("name");

		for (com.noar.dbist.annotation.Index idx : indexes) {
	...
	@Override
	public List<TableCol> getTableCols(com.noar.dbist.metadata.Table table) {
	...
	public String getProcedureDef(String name) {
		...
		try {
			return dml.selectBySql(sql, paramMap, String.class);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
