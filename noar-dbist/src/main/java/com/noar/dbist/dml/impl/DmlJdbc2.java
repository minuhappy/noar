 ...
 */
package com.noar.dbist.dml.impl;
...
import com.noar.dbist.dml.AbstractDml;
import com.noar.dbist.dml.Dml;
import com.noar.dbist.dml.Filter;
import com.noar.dbist.dml.Filters;
import com.noar.dbist.dml.Lock;
import com.noar.dbist.dml.Order;
...
import com.noar.dbist.dml.jdbc.QueryMapperSqlserver;
...
import com.noar.dbist.metadata.Sequence;
 ...
 */
public class DmlJdbc2 extends AbstractDml implements Dml {
	
	/**
	 * Logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(DmlJdbc2.class);
	...
	public Table getTable(Object obj) {
		...
		return SyncCtrlUtils.wrap("DmlJdbc.tableByClass." + clazz.getName(), tableByClassCache, clazz, new Closure<Table, RuntimeException>() {
			public Table execute() {
				...
				// Domain and Name
				com.noar.dbist.annotation.Table tableAnn = clazz.getAnnotation(com.noar.dbist.annotation.Table.class);
				if (tableAnn != null) {
	...
	private void addColumn(Table table, Field field) {
		...
		// Identity / Sequence
		com.noar.dbist.annotation.Sequence seqAnn = field.getAnnotation(com.noar.dbist.annotation.Sequence.class);
		if (seqAnn != null) {
